 ...
 */
static long (*bpf_vmalloc)(__u64 size) = (void *) 176;
 ...
 * 	0
 */
static long (*bpf_vfree)(void *addr) = (void *) 177;

/*
 * bpf_override_return2
 *
 * 	hotbpf override return
 *
 * Returns
 * 	0
 */
static long (*bpf_override_return2)(struct pt_regs *regs, __u64 rc) = (void *) 178;

/*
 * bpf_push_recycle_elem
 *
 * 	hotbpf push recycle stack
 *
 * Returns
 * 	0, -1
 */
static int (*bpf_push_recycle_elem)(void *params) = (void *) 179;

/*
 * bpf_pop_recycle_elem
 *
 * 	hotbpf pop recycle stack
 *
 * Returns
 * 	0, addr
 */
static long (*bpf_pop_recycle_elem)(void *params) = (void *) 180;

/*
 * bpf_create_slab_cache
 *
 * 	create new slab cache according to gfp_flags.
 *
 * Returns
 * 	0, new slab cache.
 */
static long (*bpf_create_slab_cache)(__u32 size, __u32 gfp_flags, __u64 ip_size_priv_type) = (void *) 181;

/*
 * bpf_cache_alloc
 *
 * 	alloc new object from slab cache
 *
 * Returns
 * 	0, addr
 */
static long (*bpf_cache_alloc)(__u64 cache, __u32 gfp_flags) = (void *) 182;
 ...
 * 	0, addr
 */
static long (*bpf_cache_free)(__u64 addr) = (void *) 183;

/*
 * bpf_set_pt_present
 *
 * 	hotbpf set page table present or not
 *
 * Returns
 * 	0
 */
static long (*bpf_set_pt_present)(__u64 addr, __u32 present) = (void *) 184;

/*
 * bpf_jmp_next
 *
 * 	hotbpf jump to the next ip
 *
 * Returns
 * 	0
 */
static long (*bpf_jmp_next)(struct pt_regs *regs, __u64 next_ip, __u64 ax) = (void *) 185;

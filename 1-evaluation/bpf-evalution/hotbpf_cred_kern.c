...
SEC("kprobe/security_cred_alloc_blank+0x60")
int probe_kmalloc_cred(struct pt_regs *ctx)
{
    u64 ip = 0;
    u64 *pv;
    u64 alloc_size = 0;
...
SEC("kprobe/security_prepare_creds+0x6b")
int probe_kmalloc2_cred(struct pt_regs *ctx)
{
    u64 ip = 0;
    u64 *pv;
    u64 alloc_size = 0;
...
SEC("kprobe/security_cred_free+0x37")
int probe_kfree_cred(struct pt_regs* ctx)
{
    u64 ip = 0;
    u64 pid = 0;
    u64 ip_size_priv = 0;

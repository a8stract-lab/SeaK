...
SEC("kprobe/alloc_fdtable+0x53")
int probe_kmem_cache_alloc_trace_fdtable(struct pt_regs *ctx)
{
    u64 ip = 0;
    u64 *pv;
    u64 alloc_size = 0;
...
SEC("kprobe/alloc_fdtable+0xe7")
int probe_kfree1_fdtable(struct pt_regs* ctx)
{
    u64 ip = 0;
    u64 pid = 0;
    u64 ip_size_priv = 0;
...
SEC("kprobe/free_fdtable_rcu+0x23")
int probe_kfree2_fdtable(struct pt_regs* ctx)
{
    u64 ip = 0;
    u64 pid = 0;
    u64 ip_size_priv = 0;
...
SEC("kprobe/alloc_fdtable+0xe7")
int probe_kfree3_fdtable(struct pt_regs* ctx)
{
    u64 ip = 0;
    u64 pid = 0;
    u64 ip_size_priv = 0;
...
SEC("kprobe/dup_fd+0x1eb")
int probe_kfree4_fdtable(struct pt_regs* ctx)
{
    u64 ip = 0;
    u64 pid = 0;
    u64 ip_size_priv = 0;
...
SEC("kprobe/dup_fd+0x289")
int probe_kfree5_fdtable(struct pt_regs* ctx)
{
    u64 ip = 0;
    u64 pid = 0;
    u64 ip_size_priv = 0;
...
SEC("kprobe/put_files_struct+0xa9")
int probe_kfree6_fdtable(struct pt_regs* ctx)
{
    u64 ip = 0;
    u64 pid = 0;
    u64 ip_size_priv = 0;

...
bool is_target_alloc_site(unsigned long curr_ip) {
	unsigned long alloc_site_array[ALLOCNUM] = {
		0xffffffff81d06f33  // hci_conn_add
	};
	int cnt = 0;
...
// ffffffff817b7470 <device_release>:
// ...
// ffffffff817b7489:       49 8b bc 24 60 02 00 00         mov    0x260(%r12),%rdi
// ffffffff817b7491:       e8 7a 8b b3 ff          call   ffffffff812f0010 <kfree> ffffffff817b7492: R_X86_64_PLT32        kfree-0x4
// ffffffff817b7496:       49 8b 84 24 c8 02 00 00         mov    0x2c8(%r12),%rax
// python3 -c 'print(hex(0xffffffff817b7496-0xffffffff817b7470))'

SEC("kprobe/device_release+0x26")

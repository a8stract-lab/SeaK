...
#define SIZE_i3c_device_id 16 /* sizeof(struct i3c_device_id) */
#define OFF_i3c_device_id_match_flags 0 /* offsetof(struct i3c_device_id, match_flags) */
#define OFF_i3c_device_id_dcr 1 /* offsetof(struct i3c_device_id, dcr) */
#define OFF_i3c_device_id_manuf_id 2 /* offsetof(struct i3c_device_id, manuf_id) */
#define OFF_i3c_device_id_part_id 4 /* offsetof(struct i3c_device_id, part_id) */
#define OFF_i3c_device_id_extra_info 6 /* offsetof(struct i3c_device_id, extra_info) */
...
#define OFF_x86_cpu_id_feature 8 /* offsetof(struct x86_cpu_id, feature) */
...
#define OFF_sdw_device_id_sdw_version 4 /* offsetof(struct sdw_device_id, sdw_version) */
#define OFF_sdw_device_id_class_id 5 /* offsetof(struct sdw_device_id, class_id) */
...
#define SIZE_tee_client_device_id 16 /* sizeof(struct tee_client_device_id) */
#define OFF_tee_client_device_id_uuid 0 /* offsetof(struct tee_client_device_id, uuid) */
#define SIZE_wmi_device_id 48 /* sizeof(struct wmi_device_id) */

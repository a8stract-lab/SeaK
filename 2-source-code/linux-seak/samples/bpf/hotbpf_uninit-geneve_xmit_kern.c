...
bool is_target_alloc_site(unsigned long curr_ip) {
	unsigned long alloc_site_array[ALLOCNUM] = {
		0xffffffff81af18fb,   // rtnl_newlink
	};
	int cnt = 0;
...
// ffffffff81af18f0 <rtnl_newlink>:
// ....
// ffffffff81af1919:       41 54                   push   %r12
// ffffffff81af191b:       e8 70 19 80 ff          call   ffffffff812f3290 <kmem_cache_alloc_trace>        ffffffff81af191c: R_X86_64_PLT32        kmem_cache_alloc_trace-0x4
// ffffffff81af1920:       48 85 c0                test   %rax,%rax
// ...
// ffffffff81af193c:       41 89 c5                mov    %eax,%r13d
// ffffffff81af193f:       e8 cc e6 7f ff          call   ffffffff812f0010 <kfree> ffffffff81af1940: R_X86_64_PLT32        kfree-0x4
// ffffffff81af1944:       41 5c                   pop    %r12

// python3 -c 'print(hex(0xffffffff81af191b-0xffffffff81af18f0))'
// python3 -c 'print(hex(0xffffffff81af193f-0xffffffff81af18f0))'

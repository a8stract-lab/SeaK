...
bool is_target_alloc_site(unsigned long curr_ip) {
	unsigned long alloc_site_array[ALLOCNUM] = {
		0xffffffff819a486a,  // __vb2_queue_alloc
	};
	int cnt = 0;
...
// ffffffff819a44a0 <__vb2_queue_free>:
// ...
// ffffffff819a4760:       49 8b 3c df             mov    (%r15,%rbx,8),%rdi
// ffffffff819a4764:       e8 a7 b8 94 ff          call   ffffffff812f0010 <kfree> ffffffff819a4765: R_X86_64_PLT32        kfree-0x4
// ffffffff819a4769:       49 c7 04 df 00 00 00 00         movq   $0x0,(%r15,%rbx,8)
// python3 -c 'print(hex(0xffffffff819a4764 - 0xffffffff819a44a0))'

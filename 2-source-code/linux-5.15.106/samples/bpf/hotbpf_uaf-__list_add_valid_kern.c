...
bool is_target_alloc_site(unsigned long curr_ip) {
	unsigned long alloc_site_array[ALLOCNUM] = {
		0xffffffff81a6d641,   // __rdma_create_id
	};
	int cnt = 0;
...
// ffffffff81a6f820 <_destroy_id>:
// ...
// ffffffff81a6f9ac:       4c 89 f7                mov    %r14,%rdi
// ffffffff81a6f9af:       e8 5c 06 88 ff          call   ffffffff812f0010 <kfree> ffffffff81a6f9b0: R_X86_64_PLT32        kfree-0x4
// ffffffff81a6f9b4:       48 83 c4 08             add    $0x8,%rsp
// python3 -c 'print(hex(0xffffffff81a6f9af-0xffffffff81a6f820))'

...
//Dump of assembler code for function __igmp_group_dropped:
//0xffffffff81c49440 <+0>:	call   0xffffffff81071c80 <__fentry__>
//....
//0xffffffff81c49587 <+327>:	shl    $0x4,%rax
//0xffffffff81c4958b <+331>:	mov    -0x7d689a90(%rax),%rdi
//0xffffffff81c49592 <+338>:	call   0xffffffff812f3270 <kmem_cache_alloc_trace>

SEC("kprobe/__igmp_group_dropped+0x152")
...
//Dump of assembler code for function ____ip_mc_inc_group:
//0xffffffff81c48e40 <+0>:	call   0xffffffff81071c80 <__fentry__>
//....
//0xffffffff81c48fd5 <+405>:	mov    $0x1000,%edx
//0xffffffff81c48fda <+410>:	mov    $0xdc0,%esi
//0xffffffff81c48fdf <+415>:	call   0xffffffff812f3270 <kmem_cache_alloc_trace>

SEC("kprobe/____ip_mc_inc_group+0x19f")
int probe_kmem_cache_alloc_trace2(struct pt_regs *ctx)
{
    u64 ip = 0;
    u64 *pv;
    u64 alloc_size = 0;
